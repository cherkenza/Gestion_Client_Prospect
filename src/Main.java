...
public class Main {
    public static void main(String[] args) {
        ...
        try {
            ...
            Prospect prospect = new Prospect("Free", new Adresse("6","victor hugo" ,"75000" , "paris") ,"0524567425", "free@free.fr", "", LocalDate.parse("03/02/2024", PATTERN_DATE), "oui");
            Prospect prospect1 = new Prospect("zara", new Adresse("2", "delivre" , "54000", "nancy"),"0896857423", "zara@zara.fr", "", LocalDate.parse("06/08/2022", PATTERN_DATE), "non");
            Prospect prospect2 = new Prospect("mango", new Adresse("5",  "bouquet","57000" , "metz"),"0589963528", "mango@mango.fr", "", LocalDate.parse("06/03/2023", PATTERN_DATE), "oui");
